        ...
        <div class="row justify-content-lg-center">
            <div class="col col-lg-6">
                <div class="justify-content-center text-center mt-1">
                    ...
                    <form class="user" method="get" role="form ">
                        <div class="form-group row">
                            <div class="col-9">
                                <input type="text" id="placa" class="form-control form-control-user" placeholder="Digite uma placa" name="placa" required onclick="submit()">
                            </div>
                            <div class="col-3 box-play">
...
<script>
    $(document).ready(function () {
        var url = '/E-stacionar/admin/api/consultaPg.php',
